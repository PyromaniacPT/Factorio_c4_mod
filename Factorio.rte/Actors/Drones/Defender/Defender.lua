...
function Create(self)
	...
	self.LifeSpanTimer:SetSimTimeLimitMS(45000)
	self.Step = 0
...
function Update(self)
	...
	if self.Step == 0 then
		AlertSound(self, 25000)
	end

	if self.Step == 1 then
		Notification(self, 17000, 25000, "25 Seconds!")
		AlertSound(self, 15000)
	end

	if self.Step == 2 then
		Notification(self, 7000, 15000, "15 Seconds!")
		AlertSound(self, 5000)
	end

	if self.Step == 3 then
		Notification(self, 2000, 5000, "5 Seconds!")
